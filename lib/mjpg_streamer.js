...
MJPG_Streamer.prototype = {
	...
	getSizeList: function() {
		...
		var sizeList = phpjs.explode("\n", sh('v4l2-ctl --list-formats-ext --device ' + this.device + ' | grep Size | awk {\'print $3\'}'));
		var res = [];
	...
	isAvailable: function() {
		...
		if (bool)
			return true;
		this.device = phpjs.trim(sh("ls /dev/video*"));
